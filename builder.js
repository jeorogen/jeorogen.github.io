            ...
            e.onload = () => {
                ...
                o.onload = () => function(e) {
                    ...
                    function r() {
                        ...
                        n.toBlob((e => {
                            s.href = URL.createObjectURL(e), s.click();
                        }), "image/jpeg");
                    }
                    ...
                    function m() {
                        d && (d.element.classList.remove("selected"), d = void 0),
                        g && (g.element.classList.remove("selected"),
                            g.element.contentEditable = !1, g = void 0);
                    }
                    ...
                    function y(e) {
                        if (e.target.classList.contains("flip")) d.element.classList.toggle("flipped");
                        else if (e.target.classList.contains("remove")) d ? (d.element.remove(), d = void 0) : (g.element.remove(), g = void 0);
                        ...
                        } else if (e.target.classList.contains("text-plus")) f(2);
                        else if (e.target.classList.contains("text-minus")) f(-2);
                        ...
                        } else if (e.target.classList.contains("drag")) { // Handle the drag button
                            const t = p(e),
                                s = d.element.getBoundingClientRect();
                            d.drag = {
                                x: t.clientX - s.x,
                                y: t.clientY - s.y
                            };
                    ...
                    function u() {
                        d && (d.drag = void 0, d.resize = void 0, d.rotate = void 0),
                        g && (g.drag = void 0);
                    }
                    ...
                    l.querySelector(".tools").onclick = e => {
                        if (e.target instanceof Image) {
                            ...
                            <div class="action drag"><img src="images/builder/drag.svg" /></div> 
